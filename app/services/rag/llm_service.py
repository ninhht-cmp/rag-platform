...
Answer:"""
    ...
    async def generate(
        ...
        try:
            ...
            if hasattr(response, "usage_metadata") and response.usage_metadata:
                ...
                # usage_metadata is an object (not dict) in langchain >= 0.3
                usage = {
    ...
    async def classify_intent(
        ...
        """
        Use secondary model (cheap) to classify which plugin handles this query.
        Returns plugin_id or None.
        """
        if not plugin_ids:
            return None
